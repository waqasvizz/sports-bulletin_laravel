...
<head>
    ...
    @if (preg_match('/\bemail_template\b/', Request::path() ) || preg_match('/\bnews_content\b/', Request::path() ) || preg_match('/\bblog\b/', Request::path() ) || preg_match('/\bstaff\b/', Request::path() ) || preg_match('/\bownAd\b/', Request::path() ))
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    @elseif (preg_match('/\bnews_content\b/', Request::path() ))
        <!-- Sub Category Script -->
