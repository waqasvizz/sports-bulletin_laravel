            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" id="filterForm" action="{{ url('/staff') }}">
                                @csrf
                                <input name="page" id="filterPage" value="1" type="hidden">
                                <div class="row">
                                    <div class="col-md-3 mb-1">
                                        <label class="form-label" for="select2-basic">Status</label>
                                        <select class="formFilter select2 form-select" name="staff_status" id="select2-account-menu-status">
                                    ...
                                    <div class="col-md-3 mb-1">    
                                        ...
                                        <select class="formFilter select2 form-select" name="orderBy_name" id="orderBy_name">
                                            ...
                                            <option value="staff.staff_title">Title</option>
                                            <option value="staff.created_at">Created At</option>
                                            <option value="staff.updated_at">Updated At</option>
                                        </select>
                                    </div>
