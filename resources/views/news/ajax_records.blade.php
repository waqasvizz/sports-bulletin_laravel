                            ...
                            <td>    
                                <div class="display_images_list">
                                    <span class="avatar-color">
                                        <a data-fancybox="demo" data-src="{{ is_image_exist($item['image_path']) }}">
                                            <img title="{{ $item['title'] }}" src="{{ is_image_exist($item['image_path']) }}" >
                                        </a>
                                    </span>
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        @can('news-edit')
                                        <a class="dropdown-item" href="{{ url('news_content')}}/{{$item['id']}}/edit" >
                                        ...
                                        @can('news-delete')
                                        <form action="{{ url('news_content/'.$item['id']) }}" method="post">
                                            @method('delete')
                                            @csrf
