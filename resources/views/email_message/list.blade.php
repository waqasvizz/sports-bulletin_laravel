                    ...
                    @if (isset($data) && count($data)>0)
                        ...
                        @foreach ($data as $key=>$item)
                            ...
                            <tr>
                                ...
                                <td>
                                    @canany(['email-message-edit', 'email-message-delete'])
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            @can('email-message-edit')
                                            <a class="dropdown-item" href="{{ url('email_message')}}/{{$item['id']}}/edit" >
                                            ...
                                            @can('email-message-delete')
                                            <form action="{{ url('email_message/'.$item['id']) }}" method="post">
                                                @method('delete')
                                                @csrf
