                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <p><img class="img-fluid" src="{{ is_image_exist($value->staff_image) }}"
                                                alt="{{ $value->staff_title }}"></p>
                                        <h4 class="card-title">{{ $value->staff_title }}</h4>
                                        <p class="card-text">{{ $value->staff_description }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="backside">
