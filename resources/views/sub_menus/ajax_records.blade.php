        ...
        <tbody>
            @if (isset($data['records']) && count($data['records'])>0)
                ...
                @foreach ($data['records'] as $key => $item)
                    ...
                    @if(! isset($item->menu_details->title) )
                        @continue
                    @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @canany(['sub-menu-edit', 'sub-menu-delete'])
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @can('sub-menu-edit')
                                    <a class="dropdown-item" href="{{ url('sub_menu')}}/{{$item['id']}}/edit" >
                                    ...
                                    @can('sub-menu-delete')
                                    <form action="{{ url('sub_menu/'.$item['id']) }}" method="post">
                                        @method('delete')
                                        @csrf
